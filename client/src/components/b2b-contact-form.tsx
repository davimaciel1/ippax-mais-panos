...
${formData.mensagem || "Gostaria de mais informações sobre compra em grande quantidade."}`;
    ...
    return (
        <section id="b2b" className="py-14 md:py-24 bg-gradient-to-b from-slate-50 to-white">
            <div className="max-w-7xl mx-auto px-4 md:px-6">
                <div className="grid lg:grid-cols-2 gap-8 md:gap-16 items-center">
                    ...
                    {/* Right - Form */}
                    <div className="bg-white rounded-2xl md:rounded-3xl shadow-xl p-5 md:p-8 border border-slate-100">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <button
                                type="submit"
                                className="w-full bg-green-500 hover:bg-green-600 text-white py-3.5 md:py-4 rounded-xl font-bold text-base md:text-lg flex items-center justify-center gap-2 md:gap-3 transition-colors shadow-lg shadow-green-500/30"
                            >
