...
// POST /api/products - Create product (Admin only) - Simplified for memory DB
...
// GET /api/products/:id/google-shopping - Get Google Shopping XML for product
...
// TODO: Update remaining routes for memory DB
// For now, focusing on GET routes for authentication testing
